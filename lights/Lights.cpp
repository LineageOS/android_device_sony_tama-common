...
#define SYS_CLASS       "/sys/class/"

#define PANEL_BACKLIGHT SYS_CLASS "backlight/panel0-backlight/"
#define LEDS            SYS_CLASS "leds/"
...
static void handleBacklight(const HwLightState& state) {
    ...
    set(PANEL_BACKLIGHT BRIGHTNESS, brightness);
}
...
static void handleNotification(const HwLightState& state) {
    ...
    /*
     * Scale RGB brightness if a brightness has been applied by the user.
     */
